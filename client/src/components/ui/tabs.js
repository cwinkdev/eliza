...
var TabsList = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(TabsPrimitive.List, __assign({ ref: ref, className: (0, utils_1.cn)("inline-flex h-9 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground", className) }, props)));
});
