...
var Button = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Comp, __assign({ type: "button", className: (0, utils_1.cn)(buttonVariants({ variant: variant, size: size, className: className })), ref: ref }, props)));
});
